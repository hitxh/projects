...
/**
 * Type of function used to print node data of the AVL tree.
 * @param 									AVL tree node.
 */
typedef void (*AVLTreePrintFunc)(AVLTreeNode *node);
...
/*
 * Print structure of the AVL tree.
 * @param tree						The tree.
 * @param print_func			Function used to print format node.
 */
void avl_tree_print(AVLTree *tree, AVLTreePrintFunc print_func);
#ifdef __cplusplus
}
#endif
